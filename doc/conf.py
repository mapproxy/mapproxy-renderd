...
intersphinx_mapping = {'mapproxy': ('http://mapproxy.org/docs/nightly/', None)}
...
html_title = "MapProxy-Renderd %s Docs" % (release, )
...
latex_documents = [
  ('index', 'MapProxy-Renderd.tex', u'MapProxy-Renderd Documentation',
